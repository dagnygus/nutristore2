import { RouterStateSnapshot, Params, Route, UrlTree } from "@angular/router";
...
export class CustomRouterSerializer implements RouterStateSerializer<RouterStateUrl> {
  ...
  serialize(routerState: RouterStateSnapshot): RouterStateUrl {
    ...
    const currentRouterStateUrl: RouterStateUrl = {
      ...
      fragment,
      // fullPath,
      lastState: this._currentState ? { ...this._currentState, lastState: null } : null,
      segemntsPaths
    }
